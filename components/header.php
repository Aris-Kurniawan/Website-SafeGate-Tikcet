    ...
    <div class="container-fluid mx-auto d-flex align-items-center justify-content-between" style="max-width: 1200px;">
        ...
        <nav class="d-none d-md-flex align-items-center gap-5 fw-medium">
            <a href="index.php?page=home" class="text-white text-decoration-none position-relative"
                ...
                Events
                <span class="position-absolute start-0 w-100 bg-safegate-neon"
                    style="bottom: -10px; height: 2px;"></span>
            </a>
            <a href="index.php?page=penjualan" class="text-safegate-text-sec text-decoration-none hover-white"
                style="font-size: 0.85rem;">Penjualan</a>
            <a href="index.php?page=cara_kerja" class="text-safegate-text-sec text-decoration-none hover-white"
                style="font-size: 0.85rem;">Cara Kerja</a>
        </nav>
